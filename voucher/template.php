...
if($getsprice == "3000"){ $color = "#9400D3";} // jika harga == "1000" maka warna = "#01579B"
elseif($getsprice == "1000"){ $color = "#FF1493";}
elseif($getsprice == "2000"){ $color = "#FF0BAA";}
...
Hubungkan ke wifi Sweet Kedai Hotspot
Buka brouser ketik  : azmi.wifi 
</div>
</td>	
